...
import { Send, ArrowLeft, User, Paperclip } from 'lucide-react';
...
const MentorChat: React.FC<MentorChatProps> = ({ otherUserId, otherUserName, currentUserId, onBack }) => {
  ...
  return (
    <div className="flex flex-col h-full bg-white rounded-lg shadow">
      {/* Header */}
      <div className="flex items-center p-4 border-b bg-purple-600 text-white rounded-t-lg">
        <button onClick={onBack} className="mr-3 p-1 hover:bg-white hover:bg-opacity-20 rounded-full">
